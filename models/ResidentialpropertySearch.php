...
class ResidentialpropertySearch extends Residentialproperty
{
    ...
    {
        $query = Residentialproperty::find();//->joinWith('amenityies',true,'right join');
