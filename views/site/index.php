                            ...
                            <div class="col-sm-7">
                              <div class="row home_pro_detail">
                                <h1>
                                  <?= $model->type?>
                                  Near
                                  <?= $model->locations?$model->locations->location:""?>
                                  .</h1>
                                <button class="button yellow_btn">
                                <?= $model->type?>
                                </button>
                                ...
                                <button class="button orrange_btn">Rent
                                <?=number_format($model->rent_details_comp)?>
                                </button>
                                <button class="button yellow_btn">Deposit
                                <?=number_format($model->deposite_details_comp)?>
                                </button>
                                <?php endif;?>
                                <?php if(strtolower($model->available_for)=="sale"):?>
                                <button class="button orrange_btn">Rate
                                <?=number_format($model->rate_details_comp)?>
                                </button>
                                <?php endif;?>
                                <div class="row">
                                  <div class="col-xs-6">
                                    <p><img src="images/shop.jpg" alt="">
                                      <?=$model->type?ucfirst($model->type):"Any"?>
                                    </p>
                                  </div>
                                  <div class="col-xs-6">
                                    <p><img src="images/car.png" alt="">Parking - Four wheeler:
                                      <?=$model->four_wheeler_parking?$model->four_wheeler_parking:"0"?>
                                      Two wheeler:
                                      <?=$model->two_wheeler_parking?$model->two_wheeler_parking:"0"?>
                                      Lift:
                                      <?=$model->lift_facility?$model->lift_facility:"0"?>
                                    </p>
                                  </div>
                                </div>
                                <div class="row">
                                  ...
                                  <div class="col-xs-6">
                                    <p><img src="images/furnished.png" alt="">Semi-Furnished</p>
                                  </div>
                                  <?php elseif(strtolower($model->furnished)=="ff"): ?>
                                  <div class="col-xs-6">
                                    <p><img src="images/furnished.png" alt="">Fully Furnished</p>
                                  </div>
                                  <?php else: ?>
                                  <div class="col-xs-6">
                                    <p><img src="images/furnished.png" alt="">Non Furnished</p>
                                  </div>
                                  <?php endif;?>
                                  <?php
							$now = time(); // or your date as well
                            ...
                            <div class="col-sm-7">
                              <div class="row home_pro_detail">
                                ...
                                <div class="row">
                                  <div class="col-xs-6">
                                    <p><img src="images/family.png" alt="">
                                      <?=$model->ideal_for?ucfirst($model->ideal_for):"Anyone"?>
                                    </p>
                                  </div>
                                  <div class="col-xs-6">
