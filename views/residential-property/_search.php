...
<?php echo \yii\helpers\Html::activeDropDownList($model,'min_rent_price',["5000"=>"5 k", "10000"=>"10 k", "15000"=>"15 k","20000"=>"20k","25000"=>"25 k", "30000"=>"30 k", "35000"=>"35 k","40000"=>"40 k","50000"=>"50 k","60000"=>"60 k","70000"=>"70 k","85000"=>"85 k","90000"=>"90 k","100000"=>"1 Lac"],['prompt'=>'Min']);?>
        ...
        <div class="col-xs-5 demo_col">
        <img src="images/rupee.jpg" alt="">
        <?php echo \yii\helpers\Html::activeDropDownList($model,'max_rent_price',["10000"=>"10 k", "15000"=>"15 k","20000"=>"20k","25000"=>"25 k", "30000"=>"30 k", "35000"=>"35 k","40000"=>"40 k","50000"=>"50 k","60000"=>"60 k","70000"=>"70 k","85000"=>"85 k","90000"=>"90 k","100000"=>"1 Lac"],['prompt'=>'Max']);?>
...
<?php echo $form->field($model, 'builtup_unit')->hiddenInput(['id'=>'resprop_builtupunit'])->label(false); ?>
