...
<div class="col-xs-5"><a href="<?= Url::to(["residential-property/index","city"=>$_GET["city"]]);?>" class="button red_btn" style="float:right; font-size:13px; margin:0"><i class="fa fa-refresh" aria-hidden="true"></i> Reset</a></div>
</div>
</div>
